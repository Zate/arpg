...
import (
	...
	"github.com/zate/arpg/backend/game"
	"github.com/zate/arpg/backend/monitor"
	"github.com/zate/arpg/backend/persistence"
	"github.com/zate/arpg/backend/simulation"
	"github.com/zate/arpg/backend/state"
	"github.com/zate/arpg/backend/utils"

	"github.com/zate/arpg/backend/events"

	"github.com/zate/arpg/backend/communication"

	"github.com/zate/arpg/backend/ai"
)
...
func main() {
	...
	server := communication.NewServer("/arpg", monitor, eventDispatcher, idManager, userNameRegistry)
